...
- Fixed aesthetic mapping failure when x grouping is missing in some
  panels.
...
- Fixed display error in `labels` parameter description of
  [`stat_compare()`](../reference/stat_compare.md).

## ggcompare 0.0.2

CRAN release: 2024-10-07

- Resolved compatibility issues with R versions 4.1 to 4.3 due to the
  use of features introduced in both R 4.2.0 and R 4.4.0, which were not
...
- Initial CRAN submission. For more details, visit:
